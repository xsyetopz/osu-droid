...
public sealed partial class SongSelectSceneTests
{
    ...
    public void RandomButtonSelectsDifferentVisibleSet()
    {
        ...
        var second = new BeatmapSetInfo(
            ...
            [
                CreateBeatmap(
                    ...
                    2.5f,
                    setId: 2,
                    setDirectory: "2 Second",
                    title: "Second",
                    artist: "Artist"
                ),
            ]
        );
        var third = new BeatmapSetInfo(
            3,
            "3 Third",
            [
                CreateBeatmap(
        ...
        var scene = new SongSelectScene(
            new FakeLibrary(new BeatmapLibrarySnapshot([first, second, third])),
            controller,
            new FakeDifficultyService(),
            CreateSongsRoot("audio.mp3"),
            randomIndexProvider: _ => 0
        );
    ...
    public void RandomButtonNoOpsWhenPopupOpen()
    {
        ...
        var scene = new SongSelectScene(
            new FakeLibrary(new BeatmapLibrarySnapshot([first, second])),
            new NoOpMenuMusicController(),
            new FakeDifficultyService(),
            CreateSongsRoot("audio.mp3"),
            randomIndexProvider: _ => 0
