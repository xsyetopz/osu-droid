...
| Mod select | `screenshots/android-mod-*.png`, `third_party/osu-droid-legacy/src/com/osudroid/ui/v2/modmenu` | `src/OsuDroid.Game/Scenes/ModSelect` | Verify scroll/fling, scrollbar bounds, disabled/selected states, footer pills, search field, preset pane, and long-description marquee. |
