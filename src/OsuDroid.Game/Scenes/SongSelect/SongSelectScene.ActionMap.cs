...
public sealed partial class SongSelectScene
{
    ...
    public static UiAction SetAction(int visibleSlot) => UiActionGroups.TryGetSongSelectSetAction(visibleSlot, out UiAction action) ? action : UiAction.None;

    public static int SetIndex(UiAction action) => UiActionGroups.TryGetSongSelectSetIndex(action, out int index) ? index : -1;

    public static UiAction DifficultyAction(int index) => UiActionGroups.TryGetSongSelectDifficultyAction(index, out UiAction action) ? action : UiAction.None;
    ...
    public static UiAction CollectionToggleAction(int index) => UiActionGroups.TryGetSongSelectCollectionToggleAction(index, out UiAction action) ? action : UiAction.None;
    ...
    public static UiAction CollectionDeleteAction(int index) => UiActionGroups.TryGetSongSelectCollectionDeleteAction(index, out UiAction action) ? action : UiAction.None;
