...
public sealed partial class SongSelectScene
{
    private UiFrameSnapshot CreateFrame(VirtualViewport viewport)
    {
        ...
        PerfDiagnostics.Log(
            "songSelect.createFrame",
            start,
            $"elements={elements.Count} sets={_visibleSnapshot.Sets.Count}"
        );
        return frame;
    }

    private static void AddBottomControls(
    ...
    )
    {
        ...
        elements.Add(
            Sprite(
                "songselect-back",
                DroidAssets.SongSelectBack,
                new UiRect(0f, backY, BackButtonSize, BackButtonSize),
                s_white,
                1f,
                UiAction.SongSelectBack
            )
        );
        ...
        elements.Add(
            Sprite(
                "songselect-mods",
                DroidAssets.SongSelectMods,
                new UiRect(modsX, smallY, SmallButtonSize, SmallButtonSize),
                s_white,
                1f,
        ...
        elements.Add(
            Sprite(
                "songselect-options",
                DroidAssets.SongSelectOptions,
                new UiRect(modsX + SmallButtonSize, smallY, SmallButtonSize, SmallButtonSize),
                s_white,
                1f,
                UiAction.SongSelectBeatmapOptions
            )
        );
        elements.Add(
            Sprite(
                "songselect-random",
                DroidAssets.SongSelectRandom,
                new UiRect(modsX + SmallButtonSize * 2f, smallY, SmallButtonSize, SmallButtonSize),
                s_white,
                1f,
                UiAction.SongSelectRandom
            )
        );
    }
    ...
    private void AddScorePreview(List<UiElementSnapshot> elements, VirtualViewport viewport)
    {
        elements.Add(
            Sprite(
                "songselect-scoring-switcher",
                DroidAssets.RankingDisabled,
                new UiRect(10f, 10f, 50f, 50f),
                s_white,
                1f
            )
        );
    ...
    private void AddTopPanelText(List<UiElementSnapshot> elements, BeatmapInfo beatmap)
    {
        ...
        elements.Add(
            Text(
                "songselect-title",
                $"{DisplayArtist(beatmap)} - {DisplayTitle(beatmap)} [{beatmap.Version}]",
                70f,
                titleY,
                1024f,
                32f,
        ...
        elements.Add(
            Text(
                "songselect-creator",
                _localizer.Format("SongSelect_BeatmapBy", beatmap.Creator),
                70f,
                creatorY,
                1024f,
                26f,
