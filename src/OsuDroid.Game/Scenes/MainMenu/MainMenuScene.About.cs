...
public sealed partial class MainMenuScene
{
    ...
    )
    {
        ...
        AddAboutText(
            ...
            panel.Y + 19f,
            "about-dialog-title",
            _localizer["MainMenu_AboutTitle"],
            contentWidth,
            25f,
            false,
            s_white,
        ...
        AddAboutText(
            elements,
            panel.X,
            panel.Y + AboutContentTop + 68f,
            "about-version",
            _localizer.Format("MainMenu_AboutVersion", _displayVersion),
            contentWidth,
            30f,
            true,
            s_white,
        ...
        AddAboutText(
            elements,
            panel.X,
            panel.Y + AboutContentTop + 138f,
            "about-made-by",
            _localizer["MainMenu_AboutMadeBy"],
            contentWidth,
            26f,
            false,
            s_white,
        ...
        AddAboutText(
            elements,
            panel.X,
            panel.Y + AboutContentTop + 174f,
            "about-copyright",
            _localizer["MainMenu_AboutCopyright"],
            contentWidth,
            26f,
            false,
            s_white,
        ...
        AddAboutText(
            ...
            firstLinkY,
            "about-osu-link",
            _localizer["MainMenu_AboutOsuWebsite"],
            contentWidth,
            26f,
            false,
            s_modalLink,
        ...
        AddAboutText(
            elements,
            panel.X,
            firstLinkY + AboutLinkGap,
            "about-droid-link",
            _localizer["MainMenu_AboutOsuDroidWebsite"],
            contentWidth,
            26f,
            false,
            s_modalLink,
            UiTextAlignment.Center,
            true,
            UiAction.MainMenuAboutOsuDroidWebsite
        );
        AddAboutText(
            elements,
            panel.X,
            firstLinkY + AboutLinkGap * 2f,
            "about-discord-link",
            _localizer["MainMenu_AboutDiscord"],
            contentWidth,
            26f,
            false,
            s_modalLink,
        ...
        AddAboutDivider(
            ...
            buttonY,
            1f,
            AboutButtonRowHeight,
            "about-button-divider"
        );
        AddAboutButton(
            elements,
            "about-changelog",
            new UiRect(panel.X, buttonY, panel.Width / 2f, AboutButtonRowHeight),
            _localizer["MainMenu_AboutChangelog"],
            UiAction.MainMenuAboutChangelog
        );
        AddAboutButton(
            elements,
            "about-close",
            new UiRect(panel.X + panel.Width / 2f, buttonY, panel.Width / 2f, AboutButtonRowHeight),
            _localizer["MainMenu_AboutClose"],
            UiAction.MainMenuAboutClose
        );
    }
    ...
    private static void AddAboutDivider(
        List<UiElementSnapshot> elements,
        float x,
        float y,
        float width,
    ...
    private static void AddAboutButton(
        List<UiElementSnapshot> elements,
        string id,
        UiRect bounds,
        string text,
