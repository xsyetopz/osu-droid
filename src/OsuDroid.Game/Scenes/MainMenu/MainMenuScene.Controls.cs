...
public sealed partial class MainMenuScene
{
    ...
    private void AddDownloaderTab(List<UiElementSnapshot> elements, VirtualViewport viewport)
    {
        ...
        elements.Add(
            new UiElementSnapshot(
                ...
                UiElementKind.Sprite,
                new UiRect(
                    viewport.VirtualWidth - tab.NativeSize.Width,
                    (viewport.VirtualHeight - tab.NativeSize.Height) / 2f,
                    tab.NativeSize.Width,
                    tab.NativeSize.Height
                ),
    ...
    private void AddReturnTransitionBackground(
        List<UiElementSnapshot> elements,
            ...
            elements.Add(
                new UiElementSnapshot(
                    ...
                    1f
                        - (float)
                            Math.Clamp(
                                _returnTransitionMilliseconds
                                    / ReturnBackgroundFadeDurationMilliseconds,
                                0d,
                                1d
                            ),
