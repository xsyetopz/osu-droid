...
public sealed partial class MainMenuScene
{
    private void AddExitDialog(List<UiElementSnapshot> elements, VirtualViewport viewport)
    {
        ...
        AddAboutText(
            ...
            panel.Y + 18f,
            "exit-dialog-title",
            _localizer["MainMenu_ExitDialogTitle"],
            panel.Width,
            26f,
            true,
            s_white,
        ...
        AddAboutDivider(
            elements,
            panel.X,
            panel.Y + ExitDialogTitleBarHeight,
            panel.Width,
            1f,
            "exit-dialog-title-divider"
        );
        ...
        AddExitDialogButton(
            ...
            "exit-dialog-cancel",
            new UiRect(
                panel.X + ExitDialogContentInset + buttonWidth + ExitDialogButtonGap,
                buttonY,
                buttonWidth,
                ExitDialogButtonHeight
            ),
    ...
    private static void AddExitDialogButton(
    ...
    private void AddDevelopmentBuildOverlay(
        List<UiElementSnapshot> elements,
    ...
    )
    {
        ...
        var textBounds = new UiRect(
            0f,
            viewport.VirtualHeight - height - 24f,
