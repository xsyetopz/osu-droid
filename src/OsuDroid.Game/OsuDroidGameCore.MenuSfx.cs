    ...
    private static string? MenuSfxKeyFor(UiAction action)
    {
        return UiActionGroups.IsOptionsSection(action) ||
            ...
            : action switch
            {
                ...
                UiAction.ModSelectClear or UiAction.ModSelectCustomize or UiAction.ModSelectSearchBox or UiAction.ModSelectPresetAdd or UiAction.ModSelectPresetNameInput => "menuclick",
                UiAction.ModSelectPresetSave or UiAction.ModSelectPresetDeleteConfirm => "menuhit",
                UiAction.ModSelectPresetCancel or UiAction.ModSelectPresetDeleteCancel => "menuback",
