    ...
    private static string? MenuSfxKeyFor(UiAction action)
    {
        return UiActionGroups.IsOptionsSection(action)
            ...
            : action switch
            {
                ...
                or UiAction.DownloaderDetailsDownloadNoVideo => "menuhit",
                UiAction.DownloaderDownloadFirst or UiAction.DownloaderDownloadFirstNoVideo =>
                    "menuhit",
                UiAction.SongSelectPropertiesOffsetMinus
                or UiAction.SongSelectPropertiesOffsetPlus => "menuhit",
                UiAction.SongSelectPropertiesFavorite
                or UiAction.SongSelectPropertiesManageCollections
                or UiAction.SongSelectPropertiesDelete => "menuclick",
                UiAction.SongSelectPropertiesOffsetInput
                or UiAction.SongSelectCollectionsNewFolder => "menuclick",
                UiAction.SongSelectPropertiesDeleteConfirm
                or UiAction.SongSelectCollectionDeleteConfirm => "menuhit",
                ...
                or UiAction.MainMenuAboutChangelog => "menuclick",
                UiAction.MainMenuAboutOsuWebsite
                or UiAction.MainMenuAboutOsuDroidWebsite
                or UiAction.MainMenuAboutDiscord => "menuclick",
                UiAction.MainMenuMusicPrevious
                or UiAction.MainMenuMusicPlay
                or UiAction.MainMenuMusicPause => "menuclick",
                UiAction.MainMenuMusicStop
                or UiAction.MainMenuMusicNext
                or UiAction.DownloaderSearchBox => "menuclick",
                UiAction.SongSelectMods
                or UiAction.SongSelectBeatmapOptions
                or UiAction.SongSelectBeatmapOptionsSearch
                or UiAction.SongSelectBeatmapOptionsFavorite
                or UiAction.SongSelectBeatmapOptionsAlgorithm
                or UiAction.SongSelectBeatmapOptionsSort
                or UiAction.SongSelectBeatmapOptionsFolder
                or UiAction.SongSelectRandom => "menuclick",
                UiAction.DownloaderSearchSubmit
                or UiAction.DownloaderRefresh
                or UiAction.DownloaderMirrorOsuDirect
                or UiAction.DownloaderMirrorCatboy => "menuclick",
                UiAction.DownloaderFilters
                or UiAction.DownloaderMirror
                or UiAction.DownloaderSort
                or UiAction.DownloaderOrder
                or UiAction.DownloaderStatus => "menuhit",
                UiAction.ModSelectClear
                or UiAction.ModSelectCustomize
                or UiAction.ModSelectSearchBox
                or UiAction.ModSelectPresetAdd
                or UiAction.ModSelectPresetNameInput => "menuclick",
                UiAction.ModSelectPresetSave or UiAction.ModSelectPresetDeleteConfirm => "menuhit",
                UiAction.ModSelectPresetCancel or UiAction.ModSelectPresetDeleteCancel =>
                    "menuback",
                UiAction.OptionsBack
                or UiAction.DownloaderBack
                or UiAction.SongSelectBack
                or UiAction.ModSelectBack => "menuback",
                UiAction.DownloaderDetailsClose or UiAction.DownloaderDownloadCancel => "menuback",
                _ => null,
            };
    }

    private static bool IsBetween(UiAction action, UiAction first, UiAction last) =>
